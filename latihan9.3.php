...
class komputer {
    ...
    // Diubah ke protected agar bisa diakses oleh class laptop (anak)
    ...
    // Diubah ke protected agar class anak bisa memanggilnya
...
class laptop extends komputer{
    ...
    public function display_ram2() {
        // Sekarang ini berfungsi karena tampilkan_ram() sudah protected
    ...
    // Diubah ke public agar bisa dipanggil oleh objek $laptop di luar class
